...
public class FlappyBird extends ApplicationAdapter {
    ...
    public void render() {
        ...
        }else if(gameState==2)
        {
            ...
            batch.draw(gameover ,Gdx.graphics.getWidth()/6 - gameover.getWidth()/2,Gdx.graphics.getHeight()/2 -gameover.getHeight());
        ...
        font.draw(batch , String.valueOf(score) , Gdx.graphics.getWidth()/20 , Gdx.graphics.getWidth()/8);
        font.draw(batch , String.valueOf(Higscore) , Gdx.graphics.getWidth()*80/100 , Gdx.graphics.getWidth()/8);
